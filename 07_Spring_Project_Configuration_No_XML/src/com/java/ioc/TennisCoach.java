...
@Scope("prototype") // @Scope("prototype") -> objeyi request olduðunda yaratýr (birden fazla) yaný adresi göstermez
//|  @Scope("singleton") -> default olarak bu objeden bir tane yaratýp onu kullanýyor yaný adresi gösterir. 
